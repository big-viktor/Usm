...
project2 = {
    ...
    text2 = "Подобрали лица рекламной кампании.Кто может рассказать более мотивирующую историю, чем звезды спорта?Именно поэтому мы выбрали самых подходящих по критериям аудитории, средними охватами и личным брендом спортсменов:Александр Большунов – чемпион мира, четырехкратный призер <br><br> Олимпийских игр по лыжным гонкам; Дина и Арина Аверины – тринадцатикратные чемпионки мира, шестикратные чемпионки Европы по художественной гимнастике Алина Балашова – звезда отечественной сноуборд индустрии<br><br>Сформировали промо материалы: Каждая история уникальна, но при этом должна полностью отражать посыл рекламной кампании. Это отлично подчеркнули архивные фотографии становления спортсменов, которые фактически иллюстрировали копирайтинг поста и усилили впечатление истории. <br><br>В конце карусели, мы добавили нативную фотографию с продукцией и спортсменами, подводя тем самым концептуальный итог истории, фокусируя внимание на бренде.",
    img1='img/project/project12/di1.jpg',
    img2='img/project/project12/di2.jpg',
    img3='img/project/project12/di1.jpg',
    img4='img/project/project12/di3.jpg',
    img5='img/project/project12/di2.jpg',
    img6='img/project/project12/di3.jpg',
...
project3 = {
    ...
    img1='img/project/project1/sl/sl9.jpg',
    img2='img/project/project1/sl/sl2.jpg',
    img3='img/project/project1/sl/sl3.jpg',
    img4='img/project/project1/sl/sl4.jpg',
    img5='img/project/project1/sl/sl6.jpg',
    img6='img/project/project1/sl/sl8.jpg',
};
project4 = {
    ...
    img1='img/project/project10/sl2.jpg',
    img2='img/project/project10/sl12.png',
    img3='img/project/project10/sl10.png',
    img4='img/project/project10/sl5.jpg',
    img5='img/project/project10/sl4.jpg',
    img6='img/project/project10/sl13.png',
};
project5 = {
    ...
    img1='img/project/project9/sl8.jpg',
    img2='img/project/project9/sl5.jpg',
    img3='img/project/project9/sl6.jpg',
    img4='img/project/project9/sl2.jpg',
    img5='img/project/project9/sl1.jpg',
    img6='img/project/project9/sl9.jpg',
};
project6 = {
...
project7 = {
    ...
    img1='img/project/project2/sl1.jpg',
    img2='img/project/project2/sl2.jpg',
    img3='img/project/project2/sl3.jpg',
    img4='img/project/project2/sl4.jpg',
    img5='img/project/project2/sl2.jpg',
    img6='img/project/project2/sl1.jpg',
...
project8 = {
    ...
    img1='img/project/project3/sl1.jpg',
    img2='img/project/project3/sl4.jpg',
    img3='img/project/project3/sl5.jpg',
    img4='img/project/project3/sl6.jpg',
    img5='img/project/project3/sl8.jpg',
    img6='img/project/project3/sl1.jpg',
};
project9 = {
    ...
    img1='img/davidich.jpg',
    img2='img/project/project6/sl1.jpg',
    img3='img/project/project6/sl1.jpg',
    img4='img/project/project6/sl1.jpg',
    img5='img/project/project6/sl1.jpg',
    img6='img/project/project6/sl1.jpg',
};
project10 = {
    ...
    img1='img/project/project4/sl1.jpg',
    img2='img/project/project4/sl2.jpg',
    img3='img/project/project4/sl3.jpg',
    img4='img/project/project4/sl4.jpg',
    img5='img/project/project4/sl5.jpg',
    img6='img/project/project4/sl8.jpg',
};
project11 = {
    ...
    img1='img/project/project8/sl2.jpg',
    img2='img/project/project8/sl3.jpg',
    img3='img/project/project8/sl7.jpg',
    img4='img/project/project8/sl8.jpg',
    img5='img/project/project8/sl9.jpg',
    img6='img/project/project8/sl11.jpg',
};
project12 = {
    ...
    img1='img/project/project7/sl1.jpg',
    img2='img/project/project7/sl2.jpg',
    img3='img/project/project7/sl3.jpg',
    img4='img/project/project7/sl4.jpg',
    img5='img/project/project7/sl5.jpg',
    img6='img/project/project7/sl6.jpg',
};
project13 = {
    ...
    img1='img/project/project5/sl1.jpg',
    img2='img/project/project5/sl2.jpg',
    img3='img/project/project5/sl3.jpg',
    img4='img/project/project5/sl4.jpg',
    img5='img/project/project5/sl5.jpg',
    img6='img/project/project5/sl6.jpg',
};
...
textProject[indSlid]
 function nextProject() {
    ...
    if(indSlid === 12){
        ...
        indSlid += +1;
        imgCase.src = textProject[indSlid].img1;
        imgCase1.src = textProject[indSlid].img2;
        imgCase2.src = textProject[indSlid].img3;
        imgCase3.src = textProject[indSlid].img4;
        imgCase4.src = textProject[indSlid].img5;
        imgCase5.src = textProject[indSlid].img6;
